...
$menuFileResetID    = New-Object System.Windows.Forms.ToolStripMenuItem
$menuFileResetID.Text = "Reset ID (ctrl-alt-h)"
$menuFileResetID.ShortcutKeys = "Control, Alt, H"
$menuFileResetID.Add_Click({ResetID})
[void]$menuFile.DropDownItems.Add($menuFileResetID)
